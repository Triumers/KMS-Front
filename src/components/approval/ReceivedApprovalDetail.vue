<template>
 ...
 async function fetchApprovalDetail(requestApprovalId) {
  try {
    ...
    const response = await axios.get(`http://triumers-back.ap-northeast-2.elasticbeanstalk.com/api/endpoint/approval/received/${requestApprovalId}`, {
      headers: {
        Authorization: `${token}`,
      },
    });
 ...
 async function approveApproval() {
  try {
    ...
    const requestApprovalId = route.params.requestApprovalId;
    await axios.post(`http://triumers-back.ap-northeast-2.elasticbeanstalk.com/api/endpoint/approval/received/${requestApprovalId}/approve`, null, {
      headers: {
        Authorization: `${token}`,
      },
    });
 ...
 async function rejectApproval() {
  try {
    ...
    const requestApprovalId = route.params.requestApprovalId;
    await axios.post(`http://triumers-back.ap-northeast-2.elasticbeanstalk.com/api/endpoint/approval/received/${requestApprovalId}/reject`, null, {
      headers: {
        Authorization: `${token}`,
      },
    });
 ...
 async function addApprover() {
  ...
  try {
    ...
    const requestApprovalId = route.params.requestApprovalId;
    await axios.post(
      `http://triumers-back.ap-northeast-2.elasticbeanstalk.com/api/endpoint/approval/received/${requestApprovalId}/addApprover`,
      {
